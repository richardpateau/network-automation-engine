...
@patch("src.compliance.routing.static.compliance.build_static")
@patch("src.compliance.routing.static.compliance.check_static")
...
@patch("src.compliance.routing.static.compliance.collect_netconf_state")
@patch("src.compliance.routing.static.compliance.configure_static")
@patch("src.compliance.routing.static.compliance.build_static")
@patch("src.compliance.routing.static.compliance.check_static")
def test_compliance_static_non_compliant_and_config_success(
        mock_check_static, mock_build_static, mock_configure_static, mock_collect_netconf_state,
        mock_sesh, mock_context, mock_device_result, mock_log
):
    mock_build_static.return_value = []
    mock_check_static.side_effect = [(False, ["(Static Routing) AD Mismatch"]), (True, [])]
...
def test_compliance_static_config_failed(
        mock_check_static, mock_build_static, mock_configure_static, mock_sesh,
...
@patch("src.compliance.routing.static.compliance.DRY_RUN", True)
@patch("src.compliance.routing.static.compliance.configure_static")
@patch("src.compliance.routing.static.compliance.build_static")
@patch("src.compliance.routing.static.compliance.check_static")
def test_compliance_static_dry_run(
        mock_check_static, mock_build_static, mock_configure_static,
        mock_sesh, mock_context, mock_device_result, mock_log
):
    mock_build_static.return_value = []
    mock_check_static.return_value = (False, ["(Static Routing) AD Mismatch"])
