...
def exp_ospf():
    return {
        ...
        "router_id": "1.1.1.1",
        "network_list": [
            {"subnet": "192.168.10.0", "wildcard": "0.0.0.255", "area": 0},
        ],
    }
...
def test_check_ospf_mismatched_area():
    expected = {
        ...
        "router_id": "1.1.1.1",
        "network_list": [
            {"subnet": "192.168.10.0", "wildcard": "0.0.0.255", "area": 1},
        ],
    }
...
def test_check_ospf_mismatched_wildcard():
    expected = {
        ...
        "router_id": "1.1.1.1",
        "network_list": [
            {"subnet": "192.168.10.0", "wildcard": "0.0.255.255", "area": 0},
        ],
    }
...
def test_check_ospf_extra_network():
    expected = {
        ...
        "router_id": "1.1.1.1",
        "network_list": [
            {"subnet": "192.168.20.0","wildcard": "0.0.0.255","area": 0}
        ],
    }
    ...
    ok, failures = check_ospf(expected, actual)
    assert any("(OSPF) Rogue Network Found | Network: 192.168.10.0" in f for f in failures)
