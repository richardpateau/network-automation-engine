...
def test_build_dhcp_valid(dhcp_netconf):
    ...
    assert {"helper_ip": "10.10.10.5" , "interface_name": "gigabitethernet2"} in result["helper"]["interfaces"]
    assert {"helper_ip": "10.10.10.6" , "interface_name": "gigabitethernet2"} in result["helper"]["interfaces"]
...
@pytesest.mark.parametrize("days,hours,minutes", 
		[
			(1, 2, 3),
			(2, 5, 30),
			(3, 10, 20), 
